...
"steam_add_already": {"zh_CN": "Steam 库里已有 AirPlay Deck（相同路径），无需重复添加。重启 Steam 后即可在游戏模式看到。",
    ...
    "pin_enable": {"zh_CN": "PIN码验证", "zh_TW": "PIN碼驗證",
                 "en": "PIN verification", "ja": "PIN認証"},
    "pin_label": {"zh_CN": "PIN码验证", "zh_TW": "PIN碼驗證",
                 "en": "PIN verification", "ja": "PIN認証"},
    
    "pin_current": {"zh_CN": "当前 PIN：{pin}", "zh_TW": "目前 PIN：{pin}",
                 "en": "PIN: {pin}", "ja": "PIN：{pin}"},
    "home_pin": {"zh_CN": "PIN：{pin}", "zh_TW": "PIN：{pin}",
                 "en": "PIN: {pin}", "ja": "PIN：{pin}"},
    "pin_value_empty": {"zh_CN": "", "zh_TW": "",
                 "en": "", "ja": ""},
    "pin_regen": {"zh_CN": "重新生成", "zh_TW": "重新產生",
                 "en": "Regenerate", "ja": "再生成"},

    
    "pin_hint": {"zh_CN": "连接时在iOS设备上输入PIN码", "zh_TW": "連線時在 iOS 裝置上輸入 PIN 碼",
                 "en": "Enter the PIN on your iOS device when connecting", "ja": "接続時にiOSデバイスでPINを入力"},
