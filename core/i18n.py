...
S: Dict[str, Dict[str, str]] = {
    ...
    "pin_ph": {"zh_CN": "例如 3939", "zh_TW": "例如 3939",
               "en": "e.g. 3939", "ja": "例: 3939",
               "ko": "예: 3939", "fr": "ex. 3939",
               "de": "z. B. 3939", "es": "p. ej. 3939"},
    "pin_hint": {"zh_CN": "勾选后，iPhone / iPad 连接时需输入此 4 位 PIN（UxPlay -pin）。",
                 "zh_TW": "勾選後，iPhone / iPad 連線時需輸入此 4 位 PIN（UxPlay -pin）。",
                 "en": "When enabled, iPhone / iPad must enter this 4-digit PIN to connect (UxPlay -pin).",
                 "ja": "有効にすると、iPhone / iPad の接続時にこの 4 桁 PIN の入力が必要です（UxPlay -pin）。",
                 "ko": "켜면 iPhone/iPad 연결 시 이 4자리 PIN을 입력해야 합니다(UxPlay -pin).",
                 "fr": "Si activé, iPhone / iPad doivent saisir ce PIN à 4 chiffres (UxPlay -pin).",
                 "de": "Wenn aktiv, müssen iPhone / iPad diese 4-stellige PIN eingeben (UxPlay -pin).",
                 "es": "Si está activo, iPhone / iPad deben introducir este PIN de 4 dígitos (UxPlay -pin)."},
    "pin_invalid": {"zh_CN": "已启用 PIN，请填写正好 4 位数字后再保存。",
                    "zh_TW": "已啟用 PIN，請填寫正好 4 位數字後再儲存。",
                    "en": "PIN is enabled — enter exactly 4 digits before saving.",
                    "ja": "PIN が有効です。保存前に 4 桁の数字を入力してください。",
                    "ko": "PIN이 켜져 있습니다. 저장 전에 숫자 4자리를 입력하세요.",
                    "fr": "PIN activé — saisissez exactement 4 chiffres avant d'enregistrer.",
                    "de": "PIN ist aktiv — bitte genau 4 Ziffern vor dem Speichern eingeben.",
                    "es": "PIN activado: introduce exactamente 4 dígitos antes de guardar."},
