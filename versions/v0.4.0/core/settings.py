...
def _migrate(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    out = dict(data)
    # vsync=sync 在本机会触发 ntp_time 基时钟错误 -> 黑屏，强制回退 off
    if out.get("vsync") == "sync":
        out["vsync"] = "off"
