...
S: Dict[str, Dict[str, str]] = {
    ...
    "reset_label": {"zh_CN": "无响应重置（秒）", "zh_TW": "無回應重置（秒）",
                    ...
                    "ko": "응답 없으면 초기화(초)", "fr": "Réinitialiser si pas de réponse (s)",
                    "de": "Zurücksetzen bei Timeout (s)", "es": "Reiniciar si no responde (s)"},
    ...
    "float_open": {"zh_CN": "设置", "zh_TW": "設定", "en": "Settings", "ja": "設定",
                   "ko": "설정", "fr": "Paramètres", "de": "Einstellungen", "es": "Ajustes"},
    ...
    "about_body": {
        ...
        "ko": (
            ...
            "게임 모드 상단에 떠 있는 제어 막대가 있어 언제든 중지하거나 설정으로 돌아갈 수 있습니다."
        ),
        "fr": (
            ...
            "Une barre flottante apparaît en mode jeu pour Arrêter / Paramètres."
        ),
        "de": (
            ...
            "Eine schwebende Leiste oben im Spielmodus für Stopp / Einstellungen."
        ),
        "es": (
            ...
            "Una barra flotante aparece arriba en modo juego para Detener / Ajustes."
        ),
    },
